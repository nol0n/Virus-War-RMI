...
@WebService(endpointInterface = "soap.net.VirusGameService")
public class ServerGameModel implements VirusGameService {
    ...
    @Override
    public synchronized void confirmReady(int playerId) {
    ...
    @Override
    public synchronized void disconnectPlayer(int playerId) {
